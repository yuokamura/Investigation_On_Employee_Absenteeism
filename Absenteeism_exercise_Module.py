...
class absenteeism_model():
    ...
    # take a dafa file (*.csv) and preprocess it in the same way as in the lecures
    def load_and_clean_data(self, data_file):
        ...
        # we will add a columns with 'NaN' string.
        df['Absenteeism Time in Hours'] = 'NaN'
        
        # create a separate df, containing dummy values for ALL available reasons
        ...
        # to avoild multicollinearity, drop the 'Reason for absence' column fromm df
        df = df.drop(['Reason for Absence'], axis = 1)
        
        # concatenate df and the 4 type of reason for absence
        df = pd.concat([df,reason_type_1,reason_type_2,reason_type_3,reason_type_4], axis =1)
        
        # assign names to the 4 reason type columns 
        # note: there is a more universal version of thi scode, however the followin 
        # will best suit our current purpose
        ...
        # convert the 'Data' column into datetime
    ...
    # predict the output and the probabilities and 
    # add columns with tehse values at the end of the new data
